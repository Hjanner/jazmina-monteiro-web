...
export default function HomeHero({ onOpenModal }) {
  return (
    <section style={{
      position: 'relative',
      minHeight: '100vh',
      ...
      <div style={{
        ...
        <div style={{ position: 'relative', width: '100%', height: '100%', display: 'flex', alignItems: 'flex-end', justifyContent: 'center' }}>
          ...
          <svg style={{ position: 'absolute', inset: 0, opacity: 0.06, width: '100%', height: '100%' }}
            ...
            <defs>
              <pattern id="home-grid" width="45" height="45" patternUnits="userSpaceOnUse">
      ...
      <style>{`
        @media (max-width: 768px) {
          .home-hero-section > div:first-of-type { display: none !important; }
        }
      `}</style>
    </section>
  )
